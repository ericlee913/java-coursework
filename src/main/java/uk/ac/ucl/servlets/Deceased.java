...
@WebServlet("/deceased.html")
public class Deceased extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        Hashtable<String, String> patientList = model.deceasedPatients();
        ...
        RequestDispatcher dispatch = context.getRequestDispatcher("/deceased.jsp");
