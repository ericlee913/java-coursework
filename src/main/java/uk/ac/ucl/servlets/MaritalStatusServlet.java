...
@WebServlet("/maritalstatusServlet.html")
public class MaritalStatusServlet extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        ArrayList<Integer> maritalProportion = model.getMarital();
        request.setAttribute("maritalProportion", maritalProportion);

        ServletContext context = getServletContext();
        RequestDispatcher dispatch = context.getRequestDispatcher("/maritalStatus.jsp");
